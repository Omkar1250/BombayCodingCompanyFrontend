                  ...
                  <div className={`group relative flex cursor-pointer  items-center justify-center gap-1 
                    ${matchRoute("/services/:serviceName") 
                      ...
                      <BsChevronDown className='mt-2 text-sm'/>
                        <div className='bg-richblack-5 absolute left-[50%] top-[50%] z-[1000]
                        flex w-[200px] translate-x-[-50%] translate-y-[3em] 
                        flex-col rounded-lg p-4 text-richblack-900 opacity-0 transition-all duration-150
                        group-hover:visible group-hover:translate-y-[2.5em] group-hover:opacity-100 lg:w-[480px] '>
